...
def CreateArgumentsParser():
    parser = argparse.ArgumentParser(description='Form GeoJson file from one album with subalbums.', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('--user', help='username', default='i-like-spam')
    parser.add_argument('--name', help='root directory', default='2013 UK')
    parser.add_argument('--output', help='output file', default='uk.geojson')
    return parser
